/*=========================================================================
  ...
  Program:   FEMRI
  Module:    $RCSfile: vtkfemriKSpaceGeneratorNSDTime.cxx,v $
  Language:  C++
...
vtkCxxRevisionMacro(vtkfemriKSpaceGeneratorNSDTime, "$Revision: 1.2 $");

vtkfemriKSpaceGeneratorNSDTime::vtkfemriKSpaceGeneratorNSDTime()
{
...
int vtkfemriKSpaceGeneratorNSDTime::RequestInformation (
...
double vtkfemriKSpaceGeneratorNSDTime::ComputeVoxelVolume()
{
...
int vtkfemriKSpaceGeneratorNSDTime::RequestData(
    vtkInformation* vtkNotUsed( request ),
...
void vtkfemriKSpaceGeneratorNSDTime::PrintSelf(ostream& os, vtkIndent indent)
{
