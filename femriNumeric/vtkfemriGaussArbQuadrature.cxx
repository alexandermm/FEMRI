/*=========================================================================
  ...
  Program:   femri
  Module:    $RCSfile: vtkfemriGaussArbQuadrature.cxx,v $
  Language:  C++
...
vtkStandardNewMacro(vtkfemriGaussArbQuadrature);
vtkCxxRevisionMacro(vtkfemriGaussArbQuadrature, "$Revision: 1.3 $");

vtkfemriGaussArbQuadrature::vtkfemriGaussArbQuadrature()
{
...
void vtkfemriGaussArbQuadrature::Initialize(vtkIdType cellType)
{
  ...
  switch(cellType)
  {
    ...
    {
      vtkfemriGaussArbQuadrature* q1D = vtkfemriGaussArbQuadrature::New();
    ...
    case VTK_QUADRATIC_TRIANGLE:
    {
      ...
      vtkfemriGaussArbQuadrature* gauss1D = vtkfemriGaussArbQuadrature::New();
      gauss1D->SetOrder(this->Order);
      gauss1D->Initialize1DGauss();
      vtkfemriGaussArbQuadrature* jacA1D = vtkfemriGaussArbQuadrature::New();
...
#endif
    {
      ...
      q1D->SetOrder(this->Order);
      q1D->Initialize1DGauss();
      vtkfemriGaussArbQuadrature* q2D = vtkfemriGaussArbQuadrature::New();
    ...
    case VTK_QUADRATIC_TETRA:
    {
      ...
      jacA1D->SetOrder(this->Order);
      jacA1D->Initialize1DJacobi(1,0);
      vtkfemriGaussArbQuadrature* jacB1D = vtkfemriGaussArbQuadrature::New();
...
void vtkfemriGaussArbQuadrature::ScaleTo01()
{
...
void vtkfemriGaussArbQuadrature::Initialize1DGauss()
{
  if (this->QuadraturePoints)
  {
    this->QuadraturePoints->Delete();
...
void vtkfemriGaussArbQuadrature::Initialize1DJacobi(int alpha, int beta)
{
  if (this->QuadraturePoints)
  {
    this->QuadraturePoints->Delete();
...
void vtkfemriGaussArbQuadrature::TensorProductQuad(vtkfemriGaussArbQuadrature* q1D)
{
...
void vtkfemriGaussArbQuadrature::TensorProductTriangle(vtkfemriGaussArbQuadrature* gauss1D, vtkfemriGaussArbQuadrature* jacA1D)
{
...
void vtkfemriGaussArbQuadrature::TensorProductHexahedron(vtkfemriGaussArbQuadrature* q1D)
{
  int numberOf1DQuadraturePoints = q1D->GetNumberOfQuadraturePoints();
...
void vtkfemriGaussArbQuadrature::TensorProductWedge(vtkfemriGaussArbQuadrature* q1D, vtkfemriGaussArbQuadrature* q2D)
{
  int numberOf1DQuadraturePoints = q1D->GetNumberOfQuadraturePoints();
...
void vtkfemriGaussArbQuadrature::TensorProductTetra(vtkfemriGaussArbQuadrature* gauss1D, vtkfemriGaussArbQuadrature* jacA1D, vtkfemriGaussArbQuadrature* jacB1D)
{
  if (gauss1D->GetNumberOfQuadraturePoints() != jacA1D->GetNumberOfQuadraturePoints())
  {
    vtkErrorMacro("Error: cannot build tensor product rule if rules have different order.");
