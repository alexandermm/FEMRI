/*=========================================================================
  ...
  Program:   femri
  Module:    $RCSfile: vtkfemriGaussQuadrature.cxx,v $
  Language:  C++
...
vtkStandardNewMacro(vtkfemriGaussQuadrature);
vtkCxxRevisionMacro(vtkfemriGaussQuadrature, "$Revision: 1.3 $");

vtkfemriGaussQuadrature::vtkfemriGaussQuadrature()
{
...
void vtkfemriGaussQuadrature::Initialize(vtkIdType cellType)
{
  ...
  switch(cellType)
  {
    ...
    {
      vtkfemriGaussQuadrature* q1D = vtkfemriGaussQuadrature::New();
    ...
    case VTK_QUADRATIC_TRIANGLE:
    {
      ...
      vtkfemriGaussQuadrature* gauss1D = vtkfemriGaussQuadrature::New();
      gauss1D->SetOrder(this->Order);
      gauss1D->Initialize1DGauss();
      vtkfemriGaussQuadrature* jacA1D = vtkfemriGaussQuadrature::New();
...
#endif
    {
      ...
      q1D->SetOrder(this->Order);
      q1D->Initialize1DGauss();
      vtkfemriGaussQuadrature* q2D = vtkfemriGaussQuadrature::New();
    ...
    case VTK_QUADRATIC_TETRA:
    {
      ...
      jacA1D->SetOrder(this->Order);
      jacA1D->Initialize1DJacobi(1,0);
      vtkfemriGaussQuadrature* jacB1D = vtkfemriGaussQuadrature::New();
...
void vtkfemriGaussQuadrature::ScaleTo01()
{
...
void vtkfemriGaussQuadrature::Initialize1DGauss()
{
  if (this->QuadraturePoints)
  {
    this->QuadraturePoints->Delete();
...
void vtkfemriGaussQuadrature::Initialize1DJacobi(int alpha, int beta)
{
  if (this->QuadraturePoints)
  {
    this->QuadraturePoints->Delete();
...
void vtkfemriGaussQuadrature::TensorProductQuad(vtkfemriGaussQuadrature* q1D)
{
...
void vtkfemriGaussQuadrature::TensorProductTriangle(vtkfemriGaussQuadrature* gauss1D, vtkfemriGaussQuadrature* jacA1D)
{
...
void vtkfemriGaussQuadrature::TensorProductHexahedron(vtkfemriGaussQuadrature* q1D)
{
  int numberOf1DQuadraturePoints = q1D->GetNumberOfQuadraturePoints();
...
void vtkfemriGaussQuadrature::TensorProductWedge(vtkfemriGaussQuadrature* q1D, vtkfemriGaussQuadrature* q2D)
{
  int numberOf1DQuadraturePoints = q1D->GetNumberOfQuadraturePoints();
...
void vtkfemriGaussQuadrature::TensorProductTetra(vtkfemriGaussQuadrature* gauss1D, vtkfemriGaussQuadrature* jacA1D, vtkfemriGaussQuadrature* jacB1D)
{
  if (gauss1D->GetNumberOfQuadraturePoints() != jacA1D->GetNumberOfQuadraturePoints())
  {
    vtkErrorMacro("Error: cannot build tensor product rule if rules have different order.");
