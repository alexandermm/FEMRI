...
## Program:   femriimagetokspacefftw.py
## Module:    $RCSfile: femriimagetokspacefftw.py,v $
## Language:  Python
...
femriimagetokspacefftw = 'femriImageToKSpaceFFTw'

class femriImageToKSpaceFFTw(pypes.pypeScript):
    ...
    def __init__(self):
        ...
        self.SetScriptName('femriimagetokspacefftw')
    ...
    def Execute(self):
        ...
        kSpaceShift = femricommon.vtkfemriImageToKSpaceFFTw()
