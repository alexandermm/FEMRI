...
femriarbquadtrimeshkspace = 'femriArbQuadTriMeshKSpace'

class femriArbQuadTriMeshKSpace(femrikspace.femriKSpace):
    ...
    def __init__(self):
        ...
        self.SetScriptName('femriarbquadtrimeshkspace')
    ...
    def AcquireKSpaceArbQuadTri(self,surface,origin,spacing):
        
        kSpaceAcquisition = femrinumeric.vtkfemriUnstructuredGridArbQuadTriKSpaceGenerator()
    ...
    def Execute(self):
        ...
        acquiredKSpace = self.AcquireKSpaceArbQuadTri(self.Mesh,origin,spacing)
