...
femrinsdtime = 'femriNSDTime'

class femriNSDTime(femrikspace.femriKSpace):
    ...
    def __init__(self):
        ...
        self.SetScriptName('femrinsdtime')
    ...
    def AcquireKSpaceNSDTime(self,surface,origin,spacing):
        
        kSpaceAcquisition = femrinumeric.vtkfemriUnstructuredGridNSDTime()
    ...
    def Execute(self):
        ...
        acquiredKSpace = self.AcquireKSpaceNSDTime(self.Mesh,origin,spacing)
