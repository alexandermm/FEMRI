...
femriquadtrimeshkspace = 'femriQuadTriMeshKSpace'

class femriQuadTriMeshKSpace(femrikspace.femriKSpace):
    ...
    def __init__(self):
        ...
        self.SetScriptName('femriquadtrimeshkspace')
    ...
    def AcquireKSpaceQuadTri(self,surface,origin,spacing):
        ...
        kSpaceAcquisition = femrinumeric.vtkfemriUnstructuredGridQuadTriKSpaceGenerator()
    ...
    def Execute(self):
        ...
        acquiredKSpace = self.AcquireKSpaceQuadTri(self.Mesh,origin,spacing)
