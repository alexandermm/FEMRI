...
femriquadtrisurfacekspace = 'femriQuadTriSurfaceKSpace'

class femriQuadTriSurfaceKSpace(femrikspace.femriKSpace):
    ...
    def __init__(self):
        ...
        self.SetScriptName('femriquadtrisurfacekspace')
